...
// parallel resampling using middle out : as per author's implementation in the paper 'Improved Parallel Resampling Methods for PF'
__global__ void par_resampling(double *cdfd, int *new_idxd, int N, double u0) {
...
int main() {
  ...
  if (fp == NULL) {
	...
	/////////////////////////////////////////////////////////////////////////////////////
		...
		par_resampling<<<(N+1023)/1024, 1024>>>(cdfd, new_idxd, N, u0);
